...
@patient = Demographic.create(last_name: 'Kurek', first_name: 'Rebecca')
#@patient = Demographic.first

@study = DicomStudy.create(demographics_id: @patient.id, study_uid: '1.2.124.113532.20.49760.3731.20090529.84722.230902', study_date: '2015-11-05 14:21:37.960', description: 'TEE', modality: 'US,SR')
